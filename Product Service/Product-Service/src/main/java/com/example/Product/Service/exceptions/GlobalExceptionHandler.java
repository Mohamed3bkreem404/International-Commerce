...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GlobalResponse<?>> handleValidation(CustomerResponseException ma) {
        var errors = List.of(
                new GlobalResponse.ErrorItem("Wrong validation ya mamlka")
        );
        return new ResponseEntity<GlobalResponse<?>>(new GlobalResponse<>(errors), HttpStatus.BAD_REQUEST);
    }
